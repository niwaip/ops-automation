...
-- Create default agent user for replay engine
-- Password hash is for 'agent_secret' using bcrypt (cost 10)
INSERT INTO users (username, password_hash, role, is_active) VALUES
(
    'replay-engine',
    '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn4p6l7m8Kj6j7i8h9g0f1e2d3c',  -- bcrypt hash for 'agent_secret'
    'agent',
    TRUE
);
...
SELECT u.id, r.id
FROM users u, roles r
WHERE u.username = 'replay-engine' AND r.name = 'agent';
