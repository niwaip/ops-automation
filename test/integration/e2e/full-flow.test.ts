...
describe('E2E Full Flow Test (TC01)', () => {
  ...
  describe('Step 2: Template (Recording → Template)', () => {
    it('should compile Playwright script to template JSON', async () => {
  ...
  describe('Step 4: AI Parameter Recognition', () => {
    it('should recognize parameters from user input', async () => {
      if (!testTemplateId) {
        return;
      }
  ...
  describe('Step 6: Session Completion', () => {
    it('should stop replay and verify session closed', async () => {
      if (!testSessionId) {
        return;
      }
  ...
  describe('TC01 Verification', () => {
    it('should verify complete execution (TC01)', async () => {
