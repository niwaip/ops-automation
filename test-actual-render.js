...
const { DocumentStructureService } = require('./apps/backend/domain/carbone-engine/dist/modules/studio/document-structure.service.js');
// Wait, is DocumentStructureService compiled? Let's check.
...
async function main() {
  ...
  const outputBuffer = await engine.render(templateBuffer, normalizedData, 'test.docx');
