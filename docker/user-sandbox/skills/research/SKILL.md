---
name: research
description: "深度技术调研、技术查看与检索、选型对比、模型评测、近30天动态追踪与真实社区口碑分析。当用户要求【查看、检查、检索、调研、排查】某个技术框架、开源项目、大模型、工具组件、技术方案或了解动态评价时必须使用此技能。核心在于主动采取事实检索与验证行动，搜集第一手技术信息与事实，严禁空口推诿。不要用于纯天气查询、纯问候闲聊或简单数学计算。"
argument-hint: "查看 DeepSeek Harness 安装方法 | 调研 Claude 3.7 真实评价 | 检索最新 AI 视频工具选型对比"
user-invocable: true
triggers:
  - "调研"
  - "调查"
