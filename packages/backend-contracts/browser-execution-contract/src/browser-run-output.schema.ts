...
export const BROWSER_RUN_OUTPUT_V2_SCHEMA_ID = 'browser-run-output/v2';
...
export const BROWSER_RUN_OUTPUT_V2_SCHEMA: Record<string, unknown> = {
  $id: BROWSER_RUN_OUTPUT_V2_SCHEMA_ID,
  type: 'object',
  additionalProperties: false,
...
export const asBrowserRunOutputV2 = (value: BrowserRunOutputV2): BrowserRunOutputV2 => value;
