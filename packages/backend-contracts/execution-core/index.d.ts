...
export declare const EXECUTION_STATUS_VALUES: ("draft" | "queued" | "running" | "waiting_input" | "pending_approval" | "human_control" | "paused" | "succeeded" | "failed" | "cancelled" | "rolled_back")[];
...
export type ExecutionStepStatus = (typeof EXECUTION_STEP_STATUS)[keyof typeof EXECUTION_STEP_STATUS];
export declare const EXECUTION_STEP_STATUS_VALUES: ("running" | "waiting_input" | "succeeded" | "failed" | "pending" | "skipped")[];
...
export declare const APPROVAL_STATUS_VALUES: ("pending" | "approved" | "rejected" | "not_required")[];
