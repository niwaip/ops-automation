...
export const isBooleanInputType = (type: string): boolean =>
...
export const parseExecutionInputValue = (
  type: string,
  value: unknown,
): unknown => {
...
): Record<string, unknown> => requiredInputs.reduce<Record<string, unknown>>((acc, field) => {
