...
export type ExecutionStatusTagColor = 'default' | 'processing' | 'warning' | 'error' | 'success';
...
export const EXECUTION_WAITING_STATUSES: ExecutionStatus[] = ['waiting_input', 'pending_approval'];
