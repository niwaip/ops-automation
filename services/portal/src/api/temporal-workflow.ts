...
// Workflow DSL - deterministic orchestration
...
// Activity DSL - non-deterministic side effects
...
export const temporalWorkflowApi = {
  ...
  update: async (id: string, data: Partial<CreateTemporalWorkflowDTO>): Promise<TemporalWorkflowDTO> => {
