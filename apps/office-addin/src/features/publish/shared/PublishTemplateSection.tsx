...
type GeneratedDataSectionPreview = {
  sectionName: string;
...
export const PublishTemplateSection: React.FC<PublishTemplateSectionProps> = ({
  suggestions,
  aiSkillGuide,
  aiGeneratedData,
  previewResult,
  ...
  const generatedDataSectionPreviews = useMemo<GeneratedDataSectionPreview[]>(() => {
    ...
    return Array.from(sectionSuggestions.entries(), ([sectionName, groupedSuggestions]) => {
