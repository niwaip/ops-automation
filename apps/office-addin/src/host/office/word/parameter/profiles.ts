import { WORD_PARAMETER_RULE_NAMES, type WordParameterRuleName } from './detect-rule-registry';
...
export const ALL_WORD_PARAMETER_RULE_NAMES: WordParameterRuleName[] = [
  ...WORD_PARAMETER_RULE_NAMES,
];

export const WORD_DOCUMENT_PARAMETER_RULE_PROFILES: Record<
  string,
...
export const HEADER_FIELD_SPECS: HeaderFieldSpec[] = [
  {
    key: 'contractNo',
    aliases: ['合同编号', '合同号', '契約番号', '契約no', 'no.', 'contract no'],
  },
  {
    key: 'signingDate',
    aliases: ['签订日期', '签约日期', '締結日', '契約締結日', 'dated', 'date'],
  },
