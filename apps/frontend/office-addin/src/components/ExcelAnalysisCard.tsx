...
import { ExcelSheetPairState } from '../taskpane/store';
              ...
              <div className="sheet-pair-list excel-reference-card-list">
                {visibleExcelPairs.length === 0 ? (
                  ...
                  visibleExcelPairs.map((pair) => {
                    const pairAnalysis = analysisSummary?.pairResults.find(p => p.pairIndex === pair.pairIndex);
                    ...
                    >
                      ...
                      {/* 渲染对应 sheet 的建议列表（独立于 pairAnalysis 存在，因为可能是从本地状态恢复的） */}
