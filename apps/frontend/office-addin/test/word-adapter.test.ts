import { WordAdapter } from '../src/adapters/word-adapter';
import { AISuggestion } from '../src/taskpane/store';

jest.mock('../src/utils/office-api', () => ({
  OfficeHelper: {
    Word: {
...
} = jest.requireMock('../src/utils/office-api') as {
  OfficeHelper: {
    Word: {
