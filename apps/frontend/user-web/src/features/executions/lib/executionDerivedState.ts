...
import { isBrowserWorkflowActivity } from '@/features/executions/lib/executionDetailQueryUtils';
...
import { isExecutionActivePollingStatus } from '@/features/executions/lib/runtimeSession';
