...
} from '@/features/executions/components/executionDetailCollapse';
import type { ExecutionListDetailDrawerProps } from '@/features/executions/lib/executionListDrawerProps';
import LiveSessionPreviewCard from '@/components/runtime/LiveSessionPreviewCard';
import ExecutionBasicInfoSection from '@/features/executions/components/ExecutionBasicInfoSection';
import ExecutionBrowserProgressCard from '@/features/executions/components/ExecutionBrowserProgressCard';
import ExecutionInputOutputCard from '@/features/executions/components/ExecutionInputOutputCard';
import ExecutionLegacyStepsTimeline from '@/features/executions/components/ExecutionLegacyStepsTimeline';
import ExecutionPhasesCollapse from '@/features/executions/components/ExecutionPhasesCollapse';
