...
import { buildExecutionDetailCollapseItem } from '@/features/executions/components/executionDetailCollapse';
...
import ExecutionPhaseStepsTimeline from '@/features/executions/components/ExecutionPhaseStepsTimeline';
import ExecutionStatusTag from '@/features/executions/components/ExecutionStatusTag';
import {
  getPhaseArtifacts,
  getPhaseSteps,
  isBrowserWorkflowActivity,
} from '@/features/executions/lib/executionDetailQueryUtils';
import { extractWorkflowActivitySnapshotSources } from '@/features/executions/lib/artifacts';
import { formatPhaseDisplayName } from '@/features/executions/lib/phaseText';
