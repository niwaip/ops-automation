...
import { ProcessStageWorkflowList } from '../components/ProcessStageWorkflowList';
import { WorkflowContractModal } from '../components/WorkflowContractModal';
...
const TemporalPage: React.FC = () => {
  ...
  const [selectedContractWorkflow, setSelectedContractWorkflow] =
    useState<AvailableBaseWorkflowItem | null>(null);
  ...
  return (
    <div style={{ padding: '8px 4px 12px' }}>
      ...
      <WorkflowContractModal
        ...
        workflow={selectedContractWorkflow}
        onClose={() => {
          setContractModalVisible(false);
          setSelectedContractWorkflow(null);
        }}
      />
    </div>
  );
