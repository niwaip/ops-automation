...
import { WORKFLOW_REGISTRY_PRISMA, WorkflowRegistryPrismaPort, getAiOrchestratorUrl } from './flow-template.ports';
...
export class ExecutionFlowValidationService {
  ...
  constructor(
    @Inject(WORKFLOW_REGISTRY_PRISMA)
    private readonly prisma: WorkflowRegistryPrismaPort
  ) {}
