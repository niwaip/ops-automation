...
import { WORKFLOW_REGISTRY_PRISMA, type WorkflowRegistryPrismaPort } from '../flow-template/flow-template.ports';
import { toTemporalWorkflowDto } from '../temporal/temporal-workflow-dto.helpers';
import { parseJson } from '../temporal/temporal-workflow-json.utils';
import { TemporalWorkflowCodegenService } from '../temporal/temporal-workflow-codegen.service';
import { TemporalWorkflowNormalizationService } from '../temporal/temporal-workflow-normalization.service';
  ...
  async generateAndSaveWorkflowCode(
    ...
    const updated = await this.prisma.temporalWorkflow.update({
      ...
      data: {
        ...
        isActive: false,
        validatedAt: null,
        validationResultJson: null as any,
        validationScore: 0,
