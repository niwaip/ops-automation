...
export type BrowserRecordingCommandLike = Record<string, unknown>;

export type BrowserRecordingParameterLike = {
  name: string;
  description: string;
  required: boolean;
  exampleValue?: string;
...
export type BrowserRecordingOutputLike = {
  name: string;
  description: string;
  location: string;
...
export type BrowserRecordingTraceLike = {
  recorderSessionId?: string;
  exportArtifactId?: string;
};

export type BrowserRecordingManualInterventionLike = {
  label: string;
