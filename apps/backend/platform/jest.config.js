module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@ops/workflow-registry$': '<rootDir>/../registry-release/workflow-registry/dist',
    '^@ops/workflow-registry/(.*)$': '<rootDir>/../registry-release/workflow-registry/dist/$1',
    '^@ops/skill-registry$': '<rootDir>/../registry-release/skill-registry/dist',
    '^@ops/skill-registry/(.*)$': '<rootDir>/../registry-release/skill-registry/dist/$1',
    '^@ops/release-manager$': '<rootDir>/../registry-release/release-manager/dist',
