...
import { RuntimeResultInterpreter } from '../runtime/runtime-result.interpreter';
...
export interface ExecutionBrowserFailureHooks {
  emitEvent: (
    executionId: string,
...
export interface ExecutionBrowserOrchestrationHooks {
  emitEvent: (
    executionId: string,
    eventType: (typeof EXECUTION_EVENT_TYPE)[keyof typeof EXECUTION_EVENT_TYPE],
    payload: unknown,
