...
export class SessionController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Create a new browser session (DEPRECATED)',
    description: 'Use /runtime-sessions instead. This endpoint will be removed in future versions.',
  })
  @ApiResponse({
  ...
  @ApiResponse({
    ...
    description: 'User already has an active session (lock conflict)',
  })
  ...
  @Post(':id/start')
  @ApiOperation({
    summary: 'Start session execution (DEPRECATED)',
    description: 'Use Execution API instead. This endpoint will be removed in future versions.',
  })
  ...
  @Post(':id/takeover')
  @ApiOperation({
    summary: 'Takeover session (human control) (DEPRECATED)',
    description:
      'Use /runtime-sessions/{id}/freeze instead. This endpoint will be removed in future versions.',
  })
  @ApiParam({ name: 'id', description: 'Session ID', type: 'string' })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Session takeover successful',
    type: SessionDto,
  })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Session not found' })
  ...
  @Post(':id/continue')
  @ApiOperation({
    summary: 'Continue session (agent control) (DEPRECATED)',
    description:
      'Use /runtime-sessions/{id}/resume instead. This endpoint will be removed in future versions.',
  })
  @ApiParam({ name: 'id', description: 'Session ID', type: 'string' })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Session continue successful',
    type: SessionDto,
  })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Session not found' })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Session not in HUMAN_CONTROL state',
  })
  ...
  @ApiOperation({
    summary: 'Delete/close session (DEPRECATED)',
    description:
      'Use /runtime-sessions/{id}/close instead. This endpoint will be removed in future versions.',
  })
  @ApiParam({ name: 'id', description: 'Session ID', type: 'string' })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Get session details (DEPRECATED)',
    description:
      'Use /runtime-sessions/{id} instead. This endpoint will be removed in future versions.',
  })
  @ApiParam({ name: 'id', description: 'Session ID', type: 'string' })
  ...
  @Get(':id/steps')
  @ApiOperation({
    summary: 'Get session step results (DEPRECATED)',
    description:
      'Use /executions/{id}/steps instead. This endpoint will be removed in future versions.',
  })
  @ApiParam({ name: 'id', description: 'Session ID', type: 'string' })
  ...
  @Get()
  @ApiOperation({
    summary: 'List sessions (DEPRECATED)',
    description: 'Use /runtime-sessions instead. This endpoint will be removed in future versions.',
  })
