...
import { ReportTemplateDTO, ReportSection, AIAnalysisResult, StepResult } from '../../interfaces';
...
export class AnalyzerService {
  ...
  private buildPrompt(section: ReportSection, context: string): string {
    const basePrompt =
      section.ai_prompt || 'Analyze the following execution results and provide a summary:';
